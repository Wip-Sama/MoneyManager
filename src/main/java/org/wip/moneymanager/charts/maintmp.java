package org.wip.moneymanager.charts;
...
public class maintmp extends Application {
    ...
    private static final Color[] COLORS = {
            Color.rgb(200, 0, 0, 0.75),
            Color.rgb(0, 0, 200, 0.75),
            Color.rgb(0, 200, 200, 0.75),
            Color.rgb(0, 200, 0, 0.75)
    };
    ...
    @Override public void init() {
        List<XYChartItem> entrate = new ArrayList<>(5);
        List<XYChartItem> spese = new ArrayList<>(5);

        Color item1Color = Color.rgb(0, 200, 0);
        Color item2Color = Color.rgb(200, 0, 0);

        entrate.add(new XYChartItem(0, 12));
        entrate.add(new XYChartItem(1, 7));
        entrate.add(new XYChartItem(2, 9));
        entrate.add(new XYChartItem(3, 3));
        entrate.add(new XYChartItem(4, 5));
        entrate.add(new XYChartItem(5, 4));

        spese.add(new XYChartItem(0, 5));
        spese.add(new XYChartItem(1, 9));
        spese.add(new XYChartItem(2, 5));
        spese.add(new XYChartItem(3, 4));
        spese.add(new XYChartItem(4, 7));
        spese.add(new XYChartItem(5, 9));

        xySeries1 = new XYSeries<>(entrate, ChartType.SMOOTH_LINE_DELTA, true);
        xySeries2 = new XYSeries<>(spese, ChartType.SMOOTH_LINE_DELTA, true);

        xySeries1.setSymbolFill(item1Color);
        xySeries1.setSymbolStroke(item1Color);

        xySeries2.setSymbolFill(item2Color);
        xySeries2.setSymbolStroke(item2Color);
        xySeries2.setSymbolSize(3);
        xySeries2.setStrokeWidth(3);

        xySeries1.setStroke(item1Color);
        xySeries1.setFill(new Color(0, 1, 0, .5));
...
//                new Stop(1, Color.rgb(0, 200, 0, 0.25))));
        ...
        xySeries2.setFill(new Color(1, 0, 0, .5));
